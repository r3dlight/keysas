<template>
  ...
  <div class="box">
    ...
    <br />
    <ul class="doc">
      <li><b class="text-info">SSH configuration</b></li>
      <ul>
      ...
      <br>
      <li><b class="text-info">Generate a IKPQPKI</b></li>
      <ul>
      ...
      <br>
      <li><b class="text-info">Enroll you Keysas stations</b></li>
      <ul>
      ...
      <br>
      <li><b class="text-info">You're now ready to go !</b></li>
    </ul>
  </div>
</template>
